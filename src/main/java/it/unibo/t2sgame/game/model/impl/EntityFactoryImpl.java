...
public class EntityFactoryImpl implements EntityFactory {
    private static final int BOSS_ENEMY_HEALTH = 25;
    private static final int BOSS_ENEMY_DAMAGE = 2;
    private static final double BOSS_ENEMY_SPEED = 0.3;
    private static final double BOSS_ENEMY_COLLISION_WIDTH = 200.0;
    private static final double BOSS_ENEMY_COLLISION_HEIGHT = 140.0;
    private static final double BOSS_ENEMY_RENDER_WIDTH = 200.0;
    private static final double BOSS_ENEMY_RENDER_HEIGHT = 140.0;
    ...
    public Entity createPlayer(final Vector2D position) {
        return new EntityImpl(position, Type.PLAYER)
                ...
                .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(position, Stats.Player.COLLISION_WIDTH, Stats.Player.COLLISION_HEIGHT), false, List.of(Type.ENEMY, Type.WALL)))
                .addComponent(this.componentFactory.createHealthComponentFrom(Stats.Player.HEALTH))
                .addComponent(this.componentFactory.createShootComponentFrom(Stats.Player.FIRERATE_SECONDS, Stats.Player.PROJECTILE_SPEED, Stats.Player.PROJECTILE_DAMAGE, Stats.Player.PROJECTILE_SIZE))
                .addComponent(
                        this.componentFactory.createGraphicComponentWithSprite("player", Stats.Player.RENDER_WIDTH, Stats.Player.RENDER_HEIGHT));
    }
    ...
    public Entity createCompanion(final Vector2D position) {
        return new EntityImpl(position, Type.COMPANION)
                ...
                .addComponent(this.componentFactory.createCollisionComponentFrom(
                        new Rectangle(position, Stats.Companion.COLLISION_WIDTH, Stats.Companion.COLLISION_HEIGHT), false, List.of(Type.WALL)))
                .addComponent(this.componentFactory.createDamageComponentFrom(Stats.Companion.DAMAGE, Stats.Companion.COOLDOWN_SECONDS))
                .addComponent(
                        this.componentFactory.createGraphicComponentWithSprite("companion", Stats.Companion.RENDER_WIDTH, Stats.Companion.RENDER_HEIGHT));
    }
    ...
    public Entity createBaseEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
                ...
                .addComponent(this.componentFactory.createDamageComponentFrom(Stats.Enemy.DAMAGE, Stats.Enemy.DAMAGE_COOLDOWN))
                .addComponent(
                        this.componentFactory.createGraphicComponentWithSprite("ice_enemy", Stats.Enemy.RENDER_WIDTH, Stats.Enemy.RENDER_HEIGHT));
    }
    ...
    public Entity createGaussianEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
                ...
                .addComponent(this.componentFactory.createCollisionComponentFrom(
                        new Rectangle(position, Stats.GaussianEnemy.COLLISION_WIDTH, Stats.GaussianEnemy.COLLISION_HEIGHT),
                        false, List.of(Type.PROJECTILE, Type.COMPANION)))
                .addComponent(this.componentFactory.createDamageComponentFrom(Stats.GaussianEnemy.DAMAGE, Stats.GaussianEnemy.DAMAGE_COOLDOWN))
                .addComponent(
                        this.componentFactory.createGraphicComponentWithSprite("fire_enemy", Stats.GaussianEnemy.RENDER_WIDTH, Stats.GaussianEnemy.RENDER_HEIGHT));
    }
    ...
    public Entity createWildEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
                ...
                .addComponent(this.componentFactory.createCollisionComponentFrom(
                        ...
                        false, List.of(Type.PROJECTILE, Type.COMPANION)))
                .addComponent(this.componentFactory.createDamageComponentFrom(Stats.WildEnemy.DAMAGE, Stats.WildEnemy.DAMAGE_COOLDOWN))
                .addComponent(
                        this.componentFactory.createGraphicComponentWithSprite("rainbow_enemy", Stats.WildEnemy.RENDER_WIDTH, Stats.WildEnemy.RENDER_HEIGHT));
    }
    ...
    public Entity createBossEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
                ...
                .addComponent(this.componentFactory.createCollisionComponentFrom(
                        ...
                        false, List.of(Type.PROJECTILE, Type.COMPANION)))
                .addComponent(this.componentFactory.createDamageComponentFrom(Stats.BossEnemy.DAMAGE, Stats.BossEnemy.DAMAGE_COOLDOWN))
                .addComponent(
                        this.componentFactory.createGraphicComponentWithSprite("crown_enemy", Stats.BossEnemy.RENDER_WIDTH, Stats.BossEnemy.RENDER_HEIGHT));
    }
