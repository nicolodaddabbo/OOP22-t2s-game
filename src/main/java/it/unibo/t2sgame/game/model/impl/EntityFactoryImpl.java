...
public class EntityFactoryImpl implements EntityFactory {
    ...
    public Entity createPlayer(final Vector2D position) {
        return new EntityImpl(position, Type.PLAYER)
            ...
            .addComponent(this.componentFactory.createShootComponentFrom(0.5, 1.5, 1, 20))
    ...
    public Entity createCompanion(final Vector2D position) {
        return new EntityImpl(position, Type.COMPANION)
            ...
            .addComponent(this.componentFactory.createPhysicsComponentFrom(50))
            .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(position, 60, 80), false , List.of()))
    ...
    public Entity createBaseEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
            ...
            .addComponent(this.componentFactory.createPhysicsComponentFrom(0.3))
            .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(position, 60, 50), 
    ...
    public Entity createGaussianEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
            ...
            .addComponent(this.componentFactory.createHealthComponentFrom(1))
            .addComponent(this.componentFactory.createPhysicsComponentFrom(0.8))
            .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(position, 60, 50), 
                 false , List.of(Type.PROJECTILE, Type.COMPANION)))
            .addComponent(this.componentFactory.createDamageComponentFrom(1, 1))
    ...
    public Entity createWildEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
            ...
            .addComponent(this.componentFactory.createHealthComponentFrom(1))
            .addComponent(this.componentFactory.createPhysicsComponentFrom(random.nextDouble(0.3, 1)))
            .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(position, 60, 50), 
                            false , List.of(Type.PROJECTILE, Type.COMPANION)))
            .addComponent(this.componentFactory.createDamageComponentFrom(1, 1))
    ...
    public Entity createBossEnemy(final Vector2D position) {
        return new EntityImpl(position, Type.ENEMY)
            .addComponent(this.componentFactory.createInputComponentFrom(new ChasingAIInputController(Type.PLAYER)))
            .addComponent(this.componentFactory.createHealthComponentFrom(25))
            .addComponent(this.componentFactory.createPhysicsComponentFrom(0.3))
            .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(position, 200, 140), 
                            false , List.of(Type.PROJECTILE, Type.COMPANION)))
