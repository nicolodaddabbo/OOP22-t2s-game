...
public class MessageTest {
    ...
    private Entity baseEntity(){
        ...
        return new EntityImpl(pos, Type.PLAYER)
            ...
            .addComponent(this.componentFactory.createCollisionComponentFrom(new Rectangle(pos, 0, 0), false, List.of()));
    }
    ...
    void testCollisionReceivePosition(){
        ...
        //The position of the collisions center should be the same as the nitified position
