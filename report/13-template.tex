...
Il progetto si pone l'obbiettivo di creare un videogioco ispirato a ``The Binding of Isaac'' \footnote{\url{https://store.steampowered.com/app/113200/The_Binding_of_Isaac/}}.
%
La nostra versione consiste in un videogioco 2D con visuale dall'alto, il personaggio controllato dal giocatore potrà muoversi all'interno della stanza in ogni direzione del piano, nella stanza verranno generati nemici aventi difficoltà man mano crescente.
%
